...
import {
  useStore, NOMINATIONS, APP_LIMIT, newDraft, countSubmitted, filledCount, fmtMB, ageFrom, ageWord,
...
export default function Cabinet() {
  ...
  const submitted = state.apps.filter(a => a.status !== 'draft')
  const drafts = state.apps.filter(a => a.status === 'draft')
  const subCount = countSubmitted(state.apps)
